...
public class GetAllPageTitles extends MWAction implements MultiAction<String> {
	...
	private static final Pattern HAS_MORE_PATTERN = Pattern.compile("<query-continue>.*?<allpages *apfrom=\"([^\"]*)\" */>.*?</query-continue>", Pattern.DOTALL | Pattern.MULTILINE);
	...
	public GetAllPageTitles getNextAction() {
		if (nextPageInfo == null) {
			...
			return new GetAllPageTitles(nextPageInfo, prefix, redirects, nonredirects, namespace);
		}
	}
}
