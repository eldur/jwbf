...
public class SearchIntegTest extends AbstractIntegTest {
  ...
  public void test() {
    ...
    // THEN
    ImmutableList<String> firstBatchTitles = ImmutableList
        .of("Design/WikiFont", "Parsoid/Bibliography", "Bug management/Phabricator etiquette");
    ImmutableList<String> secondBatchTitles = ImmutableList
        .of("VisualEditor/Node types", "Events/The Noun Project Iconathon",
