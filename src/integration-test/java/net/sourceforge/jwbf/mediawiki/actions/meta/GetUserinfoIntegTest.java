...
public class GetUserinfoIntegTest extends MocoIntegTest {
  ...
  public void test() {
    ...
    GAssert.assertEquals(splittedConfigOfString(ConfKey.USERINFO_RIGHTS), performedAction.getRights());
    GAssert.assertEquals(splittedConfigOfString(ConfKey.USERINFO_GROUPS), performedAction.getGroups());
  }
