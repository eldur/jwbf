 ...
 * href="http://trac.edgewall.org/" target="_blank">Trac</a>. This class offers a set of methods
 * which are defined in the package net.sourceforge.jwbf.actions.trac.*
 *
 * @author Thomas Stock
 */
public class TracWikiBot extends HttpBot implements WikiBot {
  ...
  /**
   * @param url wikihosturl like "http://trac.edgewall.org/wiki/"
  ...
  /**
   * @param name of article in a tracwiki like "TracWiki" , the main page is "WikiStart"
   * @return a content representation of requested article, never null on problems with http,
   * cookies and io on access problems
   * @see GetRevision
   */
