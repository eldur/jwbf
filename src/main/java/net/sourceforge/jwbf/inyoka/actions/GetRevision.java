...
public class GetRevision implements ContentProcessable {
  ...
  private static final Pattern authorPattern =
      Pattern.compile("class=\"author\">([^\"]*)<", Pattern.DOTALL | Pattern.MULTILINE);
  private static final Pattern editTimestampPattern =
      Pattern.compile("class=\"time\">([^\"]*)<", Pattern.DOTALL | Pattern.MULTILINE);
  private static final Pattern editMessagePattern =
      Pattern.compile("class=\"message\"><p>([^\"]*)</p>", Pattern.DOTALL | Pattern.MULTILINE);
