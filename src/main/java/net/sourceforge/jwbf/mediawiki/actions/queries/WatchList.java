...
public final class WatchList extends BaseQuery<WatchResponse> {
  ...
  private WatchList(MediaWikiBot bot, int limit, Date start, Date end, Direction dir,
      ImmutableList<Integer> namespaces, ImmutableList<WatchListProperties> properties, String user,
      String excludeUser, String owner, String token, ImmutableList<EditType> editTypes,
