...
public class WatchResponse {
  ...
  public WatchResponse(@JsonProperty("ns") int ns, @JsonProperty("title") String title,
      ...
      @JsonProperty("timestamp") @JsonFormat(shape = JsonFormat.Shape.STRING,
          pattern = "yyyy-MM-dd'T'hh:mm:ss'Z'") Date timestamp,
      @JsonProperty("notificationtimestamp") @JsonFormat(shape = JsonFormat.Shape.STRING,
          pattern = "yyyy-MM-dd'T'hh:mm:ss'Z'") Date notificationTimestamp,
      @JsonProperty("pageid") int pageid, @JsonProperty("revid") int revid,
      @JsonProperty("old_revid") int oldRevid, @JsonProperty("oldlen") int oldLen,
      @JsonProperty("newlen") int newLen, @JsonProperty("patrolled") boolean patrolled,
      @JsonProperty("type") String type, @JsonProperty("anon") String anon,
      @JsonProperty("minor") String minor, @JsonProperty("bot") String bot,
