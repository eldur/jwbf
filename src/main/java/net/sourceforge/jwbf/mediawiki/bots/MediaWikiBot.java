 ...
 * because some wiki admins uses url rewriting rules. In this cases the correct url is the one, which
 ...
 * 
 * On newer versions of MediaWiki, the wikiurl can be found on the wiki's Special:Version page.
 *
 * @author Thomas Stock
 * @author Tobias Knerr
